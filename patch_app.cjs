...
const oldLogoHTML = `<div className="w-24 h-24 mb-4">
          <img src="/logo.png" alt="MPM Printer Logo" className="w-full h-full object-contain drop-shadow-2xl" />
        </div>`;

const newLogoHTML = `<div className="w-24 h-24 mb-4 rounded-2xl bg-gradient-to-tr from-cyan-500/20 to-blue-600/30 border border-cyan-400/50 shadow-[0_0_25px_rgba(0,240,255,0.4)] flex items-center justify-center">
